...
import app from 'app';
import styles from './singleSimpleDetailTr.less';

class SingleSimpleDetailTr extends React.Component {
    constructor(props) {
      super(props);
            ...
            <div className={styles.leftWrap} style={{flex:1}}>
                <div style={{width: '100%'}}>
                    <div style={{display:'flex'}} className={styles.tdWrap}>
                        <div className={styles.td}  style={{flex:2,justifyContent:'flex-start',paddingLeft:24}}>
                        ...
                        <div className={styles.td}  style={{flex:'0 1'}}><div style={{width:'140px',overflowWrap:'break-word'}}>{singleData.proId}</div></div>
...
export default SingleSimpleDetailTr;