...
import app from 'app';
import styles from './groupSimpleDetailTr.less';
            ...
            <div className={styles.leftWrap} style={{flex:1}}>
                <div style={{width: '100%'}}>
                    ...
                    <div style={{display:'flex'}} className={styles.tdWrap}>
                                ...
                                <div className={styles.td}  style={{flex:'0 1'}}><div style={{width:'140px',overflowWrap:'break-word'}}>{groupOne.proId}</div></div>
